var citySelect = {}
citySelect.addressInit = function(_carea,_cmbProvince, _cmbCity, _cmbArea,defaultarea1, defaultProvince, defaultCity, defaultArea)
{
	...
	function cmbSelect(cmb, str)
	{
		for(var i=0; i<cmb.options.length; i++)
		{
			...
			{
				cmb.selectedIndex = i;
				$("#s2id_"+cmb.id).find(".select2-chosen").text(str);//bootstrap样式下需要此行
				return;
			}
		}
	}
