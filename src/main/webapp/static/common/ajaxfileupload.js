jQuery.extend({
    ...
    ajaxFileDownload : function(url){
    	var id = new Date().getTime() 
		var download_frame = $('<iframe id="fileDownFrame'+id+'" src="" style="display:none; visibility:hidden;"></iframe>');
		$(download_frame).appendTo('body');
