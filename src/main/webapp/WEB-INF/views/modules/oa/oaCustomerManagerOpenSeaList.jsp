...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oa/oaCustomerRmanager/openSeaList">公海客户</a></li>	
	</ul>
	<form:form id="searchForm" modelAttribute="oaCustomerRmanager" action="${ctx}/oa/oaCustomerRmanager/openSeaList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="oaCustomerRmanager">
			<tr>
				...
				<td>
					<a href="${ctx}/oa/oaCustomerRmanager/extractOpenSea?id=${oaCustomerRmanager.id}">
						收取
					</a>
				</td>
			</tr>
