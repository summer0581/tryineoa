...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx }/oa/oaJiabanapply/jiabanDayList?createBy.id=${oaJiabanapply.createBy.id}">加班记录</a></li>
		<li ><a href="${ctx }/oa/oaTiaoxiuapply/tiaoxiuDayList?createBy.id=${oaJiabanapply.createBy.id}">调休记录</a></li>
		<li ><h4><span class="help-inline"><font color="red">总加班时长：</font>${countJiabanHours }小时 </span></h4></li>
	...
	<form:form id="searchForm" modelAttribute="oaJiabanapply" action="${ctx}/oa/oaJiabanapply/jiabanDayList" method="post" class="breadcrumb form-search">
		<input id="createBy.id" name="createBy.id" type="hidden" value="${oaJiabanapply.createBy.id}"/>
