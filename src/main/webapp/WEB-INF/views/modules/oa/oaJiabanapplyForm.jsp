...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oa/oaJiabanapply/">加班申请列表</a></li>
		<li class="active"><a href="${ctx}/oa/oaJiabanapply/form?id=${oaJiabanapply.id}">加班申请<shiro:hasPermission name="oa:oaJiabanapply:edit">${not empty oaJiabanapply.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaJiabanapply:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaJiabanapply" action="${ctx}/oa/oaJiabanapply/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="starttime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${oaJiabanapply.starttime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="endtime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${oaJiabanapply.endtime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="hours" htmlEscape="false" maxlength="11" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">加班时段：</label>
			<div class="controls">
				<form:radiobuttons path="shiduan" items="${fns:getDictList('jiaban_shiduan')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="oa:oaJiabanapply:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
