...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oa/oaLeaveapply/">请假信息列表</a></li>
		<li class="active"><a href="${ctx}/oa/oaLeaveapply/form?id=${oaLeaveapply.id}">请假信息<shiro:hasPermission name="oa:oaLeaveapply:edit">${not empty oaLeaveapply.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaLeaveapply:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaLeaveapply" action="${ctx}/oa/oaLeaveapply/save" method="post" class="form-horizontal">
		...
		<div class="container">
			...
			<div class="">
				<div class="text-right">填表时间：<input name="createDate" type="text" readonly="readonly" maxlength="20" class="input-medium "
		...
		<div class="toolbar">
				...
				<input type="hidden" name="nodeId" value="${result.nodeId }" />
