...
public class UserTo {
	...
	public String getUserName() {
		try {
			...
			//用户名称国际化处理
			if (booleanTemp) {
				String nameTemp = ResourcesUtil.getResourcesValue(FixFlowResources.OrganizationResource, "FixFlow_user_Name_Key");
	...
	public boolean equals(Object obj) {
		// TODO Auto-generated method stub
		//System.out.println(this.getUserName()+"::"+((UserTo)obj).getUserName()+"|||"+this.getUserId()+"::"+((UserTo)obj).getUserId());
		return this.getUserId().equals(((UserTo)obj).getUserId());
	}
