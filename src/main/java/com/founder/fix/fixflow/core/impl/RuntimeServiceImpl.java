...
import com.founder.fix.fixflow.core.impl.cmd.GetProcessInstanceSimpleCmd;
...
public class RuntimeServiceImpl extends ServiceImpl implements RuntimeService {
	...
	public ProcessInstance getProcessInstanceSimple(String processInstanceId) {

		return commandExecutor.execute(new GetProcessInstanceSimpleCmd(processInstanceId));
	}
