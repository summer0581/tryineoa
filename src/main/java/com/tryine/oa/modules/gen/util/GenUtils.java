 ...
 */
package com.tryine.oa.modules.gen.util;
...
import com.tryine.oa.common.mapper.JaxbMapper;
import com.tryine.oa.common.utils.DateUtils;
import com.tryine.oa.common.utils.FileUtils;
import com.tryine.oa.common.utils.FreeMarkers;
import com.tryine.oa.common.utils.StringUtils;
import com.tryine.oa.modules.gen.entity.GenCategory;
import com.tryine.oa.modules.gen.entity.GenConfig;
import com.tryine.oa.modules.gen.entity.GenScheme;
import com.tryine.oa.modules.gen.entity.GenTable;
import com.tryine.oa.modules.gen.entity.GenTableColumn;
...
public class GenUtils {
	...
	public static String getTemplatePath(){
		String path = StringUtils.getProjectPath() + StringUtils.replaceEach(".src.main.java." + GenUtils.class.getName(), 
				...
				/*String path = GenUtils.class.getResource("").getPath().replace("util","template");*/
