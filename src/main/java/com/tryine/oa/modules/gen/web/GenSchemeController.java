 ...
 */
package com.tryine.oa.modules.gen.web;
...
import com.tryine.oa.modules.gen.service.GenSchemeService;
import com.tryine.oa.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.tryine.oa.modules");
		}
